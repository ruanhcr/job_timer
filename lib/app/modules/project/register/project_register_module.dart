...
import 'package:dart_week/app/modules/project/register/project_register_page.dart';
...
class ProjectRegisterModule extends Module {
  ...
  List<Bind<Object>> get binds => [
    BlocBind.lazySingleton((i) => ProjectRegisterController(projectService: i())), //AppModule
  ];
